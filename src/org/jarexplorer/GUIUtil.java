...
public class GUIUtil
{
    ...
    private static HashMap<String, ImageIcon> cachMap = new HashMap<String, ImageIcon>();


    /**
     *  Sets canExit boolean. This property indicates whether application
     ...
     * @param   c  component relative to which the dialog should be modal
     * @param   msg  message
     ...
     * @param   fileName  name of resource relative to the location of this class
     ...
     * if argument <code>java.awt.Component</code> has no ancestor window associated
     *
     * @param comp
     * @return
     */
    ...
    /**
     *  Pops an "info" dialog box with "OK" button
     * @param parent - parent
