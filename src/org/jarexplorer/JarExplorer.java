...
public class JarExplorer extends JFrame {
	...
	private static final long serialVersionUID = -2336370365939480692L;

	private static final String APP_NAME = "JarExplorer";
    ...
    private void showJarContent(String jarFile) {
        ArrayList<?> matchingClasses = null;
        try {
            matchingClasses = this.index.getClassesInJar(jarFile);
        } catch (Exception e) {
            e.printStackTrace();
        }
